...
class Deck:
    ...
    def __str__(self):
        ...
        for card in self.deck:
            deck_check += '\n ' +card.__str__()
        return 'The deck has:' + deck_check
...
def take_bet(chips):
    while True:
        try:
            ...
            print('Please provide a bet in an integer!')
        else: 
            if chips.bet > chips.total:
                print(f"Sorry, bet can't exceed, {chips.total}")
            else:
                break
...
while True:
    ...
    print("\nYour winnings stand at", player_chips.total)
